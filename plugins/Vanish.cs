    ...
    public class Vanish : CovalencePlugin
    {
        ...
        protected override void LoadDefaultMessages()
        {
            lang.RegisterMessages(new Dictionary<string, string>
            {
                ...
                ["Vanished"] = "Vanish:<color=#2ECC71> Enabled </color>",
                ["Reappear"] = "Vanish:<color=#E74C3C> Disabled </color>",
                ["NoPerms"] = "<color=#E74C3C>You do not have permission to do this</color>",
        ...
        {
            if (player.IsConnected) player.Message("<color=#BDC3C7>[ <color=#E74C3C>Strangeland</color> ] " + GetLang(langKey, player.Id, args) + "</color>");
        }
